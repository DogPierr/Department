...
class CHash {
  ...
  */
  virtual ~CHash() {
//    std::fstream fileLog("../prj.app/hashspeed/hashspeed.csv", std::fstream::out | std::fstream::trunc);
...
//    fileLog << "HashMapClear" << ',' << duration << ',' << amount_ << '\n';
  }
